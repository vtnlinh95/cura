...
public class ExpandableListAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        if (childPosition % 2 == 0) {
            convertView.setBackgroundColor(convertView.getResources().getColor(R.color.light_grey_3));
        } else{
            convertView.setBackgroundColor(convertView.getResources().getColor(R.color.light_grey_4));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_list_item_button) {
            ...
            if (buttonText.equals(R.string.add_specialties)) {
                Toast.makeText(v.getContext(), "Add new Specialities", Toast.LENGTH_SHORT).show();
            } else if (buttonText.equals(R.string.add_facilities)) {
